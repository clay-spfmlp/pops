...
**Pop** is an application that allows users to add their pops' information (e.g., name, owner's name, diet, age, dislikes, likes, and photo). They can also delete it or edit it anytime.
